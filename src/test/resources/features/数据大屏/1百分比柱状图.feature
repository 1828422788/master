@galaxee @galaxee1   @1.25
  Feature: 数据大屏-y百分比柱状图
#    Background:
#      Given I will see the "PublicNavBarPage" page
#      And I wait for "Dashboard" will be visible


    Scenario: 百分比柱状图-静态数据
      ...
      And I click the "Create" button
      And I wait for "2000" millsecond
      And I set the parameter "Name" with value "百分比柱状图-静态数据"
...
#        |百分比数据之静态数据  |
 ...
 ######################################无耻的分割线################################
    ...
    Scenario: 百分比柱状图-样式搜索
      ...
      And I click the "Create" button
      And I wait for "2000" millsecond
      And I set the parameter "Name" with value "百分比柱状图-样式搜索"
      And I wait for "3000" millsecond
      And I click the "Ensure" button
      Then I will see the "galaxee.NewCreatePage" page
      And switch to another window
...
#    ===============================================数据
      ...
      And I set the parameter "SplInput" with value "tag:sample04061424_chart | stats count() as ip_count by apache.clientip,apache.method | limit 12"
      And I wait for "2000" millsecond
