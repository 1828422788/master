@galaxeeIndex @galaxee  @galaxee1  @3.6
Feature: 数据大屏-动态卡片
#  Background:
...
#    And I wait for "Dashboard" will be visible
  ...
  Scenario: 动态卡片样式搜索
    ...
    When I click the "Create" button
    And I set the parameter "Name" with value "动态卡片样式搜索"
    And I click the "Ensure" button
     #选择上方的指标
    And I click the "Index" button
      #选择动态卡片
    And I click the "dynamicCard" button
...
#  名称字体粗细
  ...
  #值颜色
    ...
    And I wait for "EnsureColor" will be invisible
    #动画时长
    And I set the parameter "dynamicTime" with value "3000"
    #动画停留
    ...
    And I set the parameter "globalStyleName" with value "动态卡片自定义"
     #开启背景动画
...
#    And I click the "RecentSevenDay" button
 ...
 ######################################无耻的分割线################################
  ...
  Scenario: 动态卡片数据之静态数据
    And open the "galaxee.ListPage" page for uri "/app/galaxee/manager/"
    When I click the "Create" button
    Then I will see the "galaxee.CreatePage" page
    When I click the "Create" button
    And I set the parameter "Name" with value "动态卡片数据之静态数据"
    And I click the "Ensure" button
    #选择上方的指标
    And I click the "Index" button
      #选择动态卡片
