...
#    And I wait for "Dashboard" will be visible
  ...
  Scenario: 基本饼状图-静态数据
    ...
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "基本饼状图-静态数据"
...
#      |饼图-静态数据 |
  ...
  Scenario: 基本饼状图-样式搜索 RZY-1908,RZY-2032,RZY-2036,RZY-2033
    Given open the "galaxee.ListPage" page for uri "/app/galaxee/manager/"
    When I click the "Create" button
    Then I will see the "galaxee.CreatePage" page
    And switch to another window
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "基本饼状图-样式搜索"
    And I wait for "3000" millsecond
    And I click the "Ensure" button
    Then I will see the "galaxee.NewCreatePage" page
    And switch to another window
...
#    ==============================选择样式
    ...
    #半径
    And I wait for "Radius1" will be visible
    And I set the parameter "Radius1" with value "0.9"
    And I wait for "3000" millsecond
