...
Feature: 数据大屏-v水平分组柱状图
#  Background:
#    Given I will see the "PublicNavBarPage" page
#    And I wait for "Dashboard" will be visible

  Scenario: 水平分组柱状图-静态数据
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "水平分组柱状图-静态数据"
...
#    ==============================选择样式
    ...
    And I wait for "1000" millsecond
    And I set the parameter "CapsuleWidth" with value "30"
    And I wait for "2000" millsecond
...
##################################无耻的分割线###############################
  ...
  Scenario: 水平分组柱状图-样式搜索
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "水平分组柱状图-样式搜索"
    And I wait for "3000" millsecond
    And I click the "Ensure" button
    Then I will see the "galaxee.NewCreatePage" page
    And switch to another window
...
#    And I wait for "LayoutBottom" will be visible
    ...
    And I set the parameter "LayoutLeft" with value "80"
    And I wait for "2000" millsecond
...
#     ===================================系列
    ...
    And I wait for "2000" millsecond
    And I set the parameter "TitleText" with value "Get"
    And I wait for "2000" millsecond
#   ===========================================
    ...
    And I wait for "2000" millsecond
    And I set the parameter "TitleText" with value "Set"
    And I wait for "2000" millsecond
    And I click the "SeriesOne" button
    And I wait for "1000" millsecond
    And I set the parameter "fillColor1" with value "#0000FF"
    ...
    And I set the parameter "SplInput" with value "tag:sample04061424_chart | stats count() as ip_count by apache.clientip,apache.method | sort by ip_count | limit 10"
    And I wait for "2000" millsecond
    ...
    And I set the parameter "Yaxis" with value "ip_count"
