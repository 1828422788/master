...
#    And I wait for "Dashboard" will be visible
  ...
  Scenario: 基本散点图-静态数据
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "基本散点图-静态数据"
...
#    ==============================图表布局
    ...
    And I wait for "2000" millsecond
    And I choose the "菱形" from the "ScatterShape"
    And I set the parameter "ScatterSize" with value "20"
    And I wait for "2000" millsecond
...
#      |散点图-图例-分组-静态数据 |
  ...
  ##################################无耻的分割线##############################
  Scenario: 基本散点图-样式搜索 RZY-2554,RZY-2619,RZY-2620,RZY-2621,RZY-2622,RZY-2624
    Given open the "galaxee.ListPage" page for uri "/app/galaxee/manager/"
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "基本散点图-样式搜索"
    And I wait for "3000" millsecond
    And I click the "Ensure" button
    Then I will see the "galaxee.NewCreatePage" page
    And switch to another window
