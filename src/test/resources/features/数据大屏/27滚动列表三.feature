...
Feature: 滚动列表三
  ...
  Scenario: 滚动列表三默认设置
    ...
    When I click the "Create" button
    And I set the parameter "Name" with value "滚动列表三默认设置"
  ...
  Scenario Outline: 滚动列表三默认设置发布并截图
    Given I will see the "PublicNavBarPage" page
    And I wait for "Dashboard" will be visible
    And open the "galaxee.ListPage" page for uri "/app/galaxee/manager/"
  ...
  Scenario: 滚动列表3样式
    ...
    Then I will see the "galaxee.CreatePage" page
    When I click the "Create" button
    And I set the parameter "Name" with value "滚动列表3样式"
    And I click the "Ensure" button
    #选择上方的图表
    And I click the "Chart" button
      #选择滚动列表三
...
#修改样式
    ...
    Then take a screenshot with name "galaxee/滚动列表3样式编辑页"
     #保存
    And I wait for "Save" will be visible
    And I click the "Save" button
    Then I will see the success message "保存成功"
...
######################################无耻的分割线################################
  ...
  Scenario: 滚动列表3数据之搜索
    ...
    Then I will see the "galaxee.CreatePage" page
    When I click the "Create" button
    And I set the parameter "Name" with value "滚动列表3数据之搜索"
    And I click the "Ensure" button
      #选择上方的图表
    And I click the "Chart" button
      #选择滚动列表三
  ...
  Scenario Outline: 滚动列表3数据之搜索发布并截图
    Given I will see the "PublicNavBarPage" page
    And I wait for "Dashboard" will be visible
    And open the "galaxee.ListPage" page for uri "/app/galaxee/manager/"
    When the galaxee name is "<name>" then I click the "iconfont icon-fabu" button
