...
#    And I wait for "Dashboard" will be visible
  ...
  Scenario: 基本柱状图-静态数据 RZY-1906,RZY-2018,RZY-2019,RZY-2020,RZY-2022,RZY-2023
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "基本柱状图-静态数据"
...
##################################无耻的分割线##############################
  ...
  Scenario: 基本柱状图-样式搜索
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "基本柱状图-样式搜索"
    And I wait for "3000" millsecond
    And I click the "Ensure" button
    Then I will see the "galaxee.NewCreatePage" page
    And switch to another window
...
#     ===================================系列
    ...
    And I set the parameter "SplInput" with value "tag:sample04061424_chart | stats count() by apache.clientip"
    And I wait for "2000" millsecond
