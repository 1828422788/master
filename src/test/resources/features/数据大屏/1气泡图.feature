...
#    And I wait for "Dashboard" will be visible
  ...
  Scenario: 气泡图-静态数据
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "气泡图-静态数据"
...
#    ==============================图表布局
    ...
    And I wait for "2000" millsecond
    And I choose the "三角形" from the "BubbleShape"
    And I wait for "2000" millsecond
    And I set the parameter "BubbleSizeMin" with value "10"
    And I set the parameter "BubbleSizeMax" with value "100"
    And I wait for "2000" millsecond
    ...
    And I wait for "2000" millsecond
    And I click the "Values" button
#    And I wait for "ValuesPosition" will be visible
#    And I choose the "底部" from the "ValuesPosition"
...
#    And I wait for "2000" millsecond
    ...
    And I set the parameter "Raxis" with value "r"
    ...
    And I wait for element "RaxisFieldText" change text to "匹配成功"
    And I wait for "2000" millsecond
  ...
  Scenario: 气泡图-样式搜索
    ...
    And I click the "Create" button
    And I wait for "2000" millsecond
    And I set the parameter "Name" with value "气泡图-样式搜索"
    And I wait for "3000" millsecond
    And I click the "Ensure" button
    Then I will see the "galaxee.NewCreatePage" page
    And switch to another window
...
#     ===================================系列
    ...
    And I wait for "1000" millsecond
    And I set the parameter "ScatterFillColor" with value "#FFCC00"
    And I wait for "2000" millsecond
    And I set the parameter "SeriexText" with value "Get"
    And I wait for "2000" millsecond
#   ===========================================
    And I click the "SeriesTwo" button
    And I wait for "1000" millsecond
    And I set the parameter "ScatterFillColor" with value "#E6E6FA"
    And I wait for "2000" millsecond
    And I set the parameter "SeriexText" with value "Set"
    And I wait for "2000" millsecond
    And I click the "SeriesOne" button
    And I wait for "1000" millsecond
    And I set the parameter "ScatterFillColor" with value "#0000FF"
...
#    And I set the parameter "SplInput" with value "tag:sample04061424_chart | bucket timestamp span=2h as ts |stats count(apache.status) as a ,count(apache.status) as b  by apache.status,apache.method"
#    有一个问题，这里的x只能识别字符串的内容，对于非字符串的无法识别，所以用上述方法，会无法出现图
    And I set the parameter "SplInput" with value "tag:sample04061424_chart | bucket timestamp span=2h as ts |stats count() as a ,count() as b  by apache.clientip,apache.method | limit 8"
    And I wait for "2000" millsecond
    ...
    And I set the parameter "FirstYaxis" with value "a"
    And I set the parameter "Raxis" with value "b"
