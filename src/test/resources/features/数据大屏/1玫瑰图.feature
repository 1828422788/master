@galaxee @galaxee0  @1.15
Feature: 数据大屏-o玫瑰图
#  Background:
#    Given I will see the "PublicNavBarPage" page
#    And I wait for "Dashboard" will be visible

  Scenario: 玫瑰图-样式搜索 RZY-3028
...
#    And I click the "TagWordColor" button
    ...
    And I set the parameter "globalStyleName" with value "玫瑰图-样式搜索"
    #开启背景动画
...
##################################无耻的分割线###############################
  ...
  Scenario: 玫瑰图-绑定搜索
    ...
    Then I will see the "galaxee.CreatePage" page
    When I click the "Create" button
    And I set the parameter "Name" with value "玫瑰图-绑定搜索"
    And I click the "Ensure" button
      #在【其他】中添加一个【搜索】控件
