...
Feature: 报表新建
  ...
  @smoke @reportSmoke
    Examples: 保存成功
      ...
      | autotest1 |          | owner       | default_Report | PDF        | sun.xiaojing@yottabyte.cn | 报表名称：<%report_name%>, 发送时间：<%report_time%> | 0 0-2 9 * * ?        | rose       | Layout1 | 保存成功   |
      | autotest2 |          | owner       | default_Report | PDF        | sun.xiaojing@yottabyte.cn | 报表名称：<%report_name%>, 发送时间：<%report_time%> | 0 0/15 9 ? * MON-FRI | rose       | Layout1 | 保存成功   |
      | autotest3 |          | owner       | default_Report | PDF        | sun.xiaojing@yottabyte.cn | 报表名称：<%report_name%>, 发送时间：<%report_time%> | 0 5 9 1/3 * ?        | rose       | Layout1 | 保存成功   |
