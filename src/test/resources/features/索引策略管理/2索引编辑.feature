...
Feature: 索引信息编辑（RZY-1477至1480）
  ...
  Scenario:修改索引冻结
    Given the data name is "{'column':'0','name':'index_freez'}" then i click the "编辑" button without paging
    Then I will see the "index.CreatePage" page
  ...
  Scenario:关闭冻结索引
    Given the data name is "{'column':'0','name':'index_freez'}" then i click the "编辑" button without paging
    Then I will see the "index.CreatePage" page
    And I switch the "索引冻结" button to "unchecked"
    And I click the "SavedButton" button
    And I will see the element "Message" name is "保存成功"

  Scenario:修改索引下沉hdd
    Given the data name is "{'column':'0','name':'index_sink'}" then i click the "编辑" button without paging
    Then I will see the "index.CreatePage" page
