...
Feature: 索引信息编辑（RZY-1477至1480）
  ...
  Scenario Outline:
    Given the data name is "autotest" then i click the "编辑" button without paging
    ...
    Examples:
      | desc | savedTime | savedTimeDropDown | divideTime | divideTimeDropDown | savedSize | savedSizeDropDown | message |
      | test | 3         | 年                 | 1          |                    | 10        | KB                | 保存成功    |
      | test | 3         | 天                 | 1          |                    | 10        | MB                | 保存成功    |
      | test | 3         | 年                 | 1          | 年                  | 1         | PB                | 保存成功    |
      | test | 3         | 月                 | 1          | 月                  | 1         | TB                | 保存成功    |
      | test | 3         | 天                 | 1          | 天                  | 1         | KB                | 保存成功    |
      | test | 3         | 天                 | 1          | 天                  | 1         | Byte              | 保存成功    |
