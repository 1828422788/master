...
#    And I choose contain the "接收策略一级组" from the "MailReceiverList"
#    And I choose3 the "接收策略一级组" from the "MailReceiverList"
    And I set the parameter "MailReceiver" with value "接收策略一级组"
