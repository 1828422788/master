...
#    Then I choose the "<unit>" from the "MaxLineDropdown"
    ...
    Examples:
      ...
      | alert_stats_len_avg                         | starttime="now/d" endtime="now/d+24h" tag:sample04061424 \| stats avg(apache.resp_len) as avg_len by apache.clientip                                                                                                                                                                                                                   |                    |                   |
