...
#      | m1_eval_2(2)     | tag:sample04061424 \| eval x=`m1_eval_2(1,2)` \| table x                   | tag:sample04061424 \| eval x=if(isstr(apache.clientip),1-2,1+2) \| table x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
      | m2_eval_2(2)                   | tag:sample04061424 \| eval x=`m2_eval_2(1,2)` \| table x                   | tag:sample04061424 \| eval x="3" \| table x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
      | m1_2(2)                        | tag:sample04061424 \| eval x=`m1_2(1,2)` \| table x                        | tag:sample04061424 \| eval x=if(isstr(apache.clientip),1-2,1+2) \| table x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
      | m2_2(2)                        | tag:sample04061424 \| eval x=`m2_2(1,2)` \| table x                        | tag:sample04061424 \| eval x="if(isstr(apache.clientip),1-2,1+2)" \| table x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
      | mne_if_2(2)                    | tag:sample04061424 \| eval x=`mne_if_2(1,2)` \| table x                    | tag:sample04061424 \| eval x="if(isstr(apache.method),1-2,1+2)" \| table x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
#      | app_permission_sample_two_param | tag:sample04061424 \| stats count() as ip_cnt by apache.clientip, apache.version \| where apache.clientip==$x$ && apache.version==$y$ |
...
#    Then I will see the success message "提交成功，请到设置-下载管理页查看下载状态！"
    ...
    Examples:
      ...
      | makesession                                 | tag:sample04061424 \| transaction apache.clientip maxspan=30m keepevicted=true                                                                                                                                                                                                                                                         |                    |                   |
