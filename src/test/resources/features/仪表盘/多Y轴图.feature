...
#    Then I will see the "TextAce" result will be "<json>"
  ...
  Scenario Outline: labelRotate-left-right-horizontal-vertical RZY-1325,RZY-1326,RZY-1327,RZY-1328
    ...
    When the chart title is "<name>" then I click the button which classname is "yotta-icon yotta-icon-DotEmblemOutlined" in dashboard
    And I click the "Edit" button
    Then I set the parameter "{  "title": "仪表盘多Y轴图",  "x": 0,  "y": 0,  "w": 12,  "h": 5,  "search": {    "query": "tag:sample04061424_display | stats count(apache.resp_len), max(apache.resp_len), min(apache.resp_len), sum(apache.status), avg(apache.resp_len) by apache.resp_len,apache.status | limit 10",    "startTime": "now/d",    "endTime": "now"  },  "chart": {    "chartType": "multiaxis",    "xAxis": {      "field": "apache.resp_len",      "labelRotate": "<labelRotate>",      "sortOrder": "default"    },    "yAxisAttrs": [      {        "fields": [          {            "color": "#2A76E4",            "connectNull": false,            "name": "count(apache.resp_len)",            "opacity": 0.6,            "smooth": false,            "type": "line"          }        ],        "range": {}      },      {        "fields": [          {            "color": "#5C9DF5",            "connectNull": false,            "name": "max(apache.resp_len)",            "opacity": 0.6,            "smooth": false,            "type": "column"          }        ],        "range": {          "max": "",          "min": 2        },        "unit": "柱"      }    ],    "precision": "",    "showAllXAxisLabels": false,    "labelInterval": "",    "customLabel": "",    "byFields": [      "apache.status"    ],    "legend": {      "placement": "bottom"    }  }}" to json editor
    And I wait for "500" millsecond
...
#    Then I will see the success message "校验通过"
  ...
  Scenario Outline: sortOrder-default-desc-asc RZY-1329,RZY-1330,RZY-1331
    ...
    When the chart title is "<name>" then I click the button which classname is "yotta-icon yotta-icon-DotEmblemOutlined" in dashboard
    And I click the "Edit" button
    Then I set the parameter "{  "title": "仪表盘多Y轴图",  "x": 0,  "y": 0,  "w": 12,  "h": 5,  "search": {    "query": "tag:sample04061424_display | stats count(apache.resp_len), max(apache.resp_len), min(apache.resp_len), sum(apache.status), avg(apache.resp_len) by apache.resp_len,apache.status | limit 10",    "startTime": "now/d",    "endTime": "now"  },  "chart": {    "chartType": "multiaxis",    "xAxis": {      "field": "apache.resp_len",      "labelRotate": "left",      "sortOrder": "<sortOrder>"    },    "yAxisAttrs": [      {        "fields": [          {            "color": "#2A76E4",            "connectNull": false,            "name": "count(apache.resp_len)",            "opacity": 0.6,            "smooth": false,            "type": "line"          }        ],        "range": {}      },      {        "fields": [          {            "color": "#5C9DF5",            "connectNull": false,            "name": "max(apache.resp_len)",            "opacity": 0.6,            "smooth": false,            "type": "column"          }        ],        "range": {          "max": "",          "min": 2        },        "unit": "柱"      }    ],    "precision": "",    "showAllXAxisLabels": false,    "labelInterval": "",    "customLabel": "",    "byFields": [      "apache.status"    ],    "legend": {      "placement": "bottom"    }  }}" to json editor
    And I wait for "500" millsecond
    And I click the "Check" button
#    Then I will see the success message "校验通过"
    Then I click the "Ensure" button
...
#    Then I will see the success message "校验通过"
  ...
  Scenario Outline: 设置对象个数为1个，修改type RZY-1332,RZY-1334,RZY-3727,RZY-3728,RZY-3729
    ...
    When the chart title is "仪表盘多Y轴图" then I click the button which classname is "yotta-icon yotta-icon-DotEmblemOutlined" in dashboard
    And I click the "Edit" button
    Then I set the parameter "{  "title": "仪表盘多Y轴图",  "description": "",  "x": 0,  "y": 0,  "w": 12,  "h": 5,  "search": {    "query": "tag:sample04061424_display | stats count(apache.resp_len), max(apache.resp_len), min(apache.resp_len), sum(apache.status), avg(apache.resp_len) by apache.resp_len,apache.status | limit 10",    "startTime": "now/d",    "endTime": "now"  },  "chart": {    "chartType": "multiaxis",    "xAxis": {      "field": "apache.resp_len",      "labelRotate": "left",      "sortOrder": "default"    },    "yAxisAttrs": [      {        "fields": [          {            "color": "#2A76E4",            "connectNull": false,            "name": "count(apache.resp_len)",            "opacity": 0.6,            "smooth": false,            "type": "<type>"          }        ],        "range": {}      }    ],    "precision": "",    "showAllXAxisLabels": false,    "labelInterval": "",    "customLabel": "",    "byFields": [      "apache.status"    ],    "legend": {      "placement": "bottom"    }  }}" to json editor
    And I wait for "500" millsecond
    And I click the "Check" button
#    Then I will see the success message "校验通过"
    And I wait for "500" millsecond
  ...
  Scenario: 将field字段值改为min(apache.resp_len) RZY-1335,RZY-1336,RZY-1340
    ...
    When the chart title is "仪表盘多Y轴图" then I click the button which classname is "yotta-icon yotta-icon-DotEmblemOutlined" in dashboard
    And I click the "Edit" button
    Then I set the parameter "{  "title": "仪表盘多Y轴图",  "description": "",  "x": 0,  "y": 0,  "w": 12,  "h": 5,  "search": {    "query": "tag:sample04061424_display | stats count(apache.resp_len), max(apache.resp_len), min(apache.resp_len), sum(apache.status), avg(apache.resp_len) by apache.resp_len,apache.status | limit 10",    "startTime": "now/d",    "endTime": "now"  },  "chart": {    "chartType": "multiaxis",    "xAxis": {      "field": "apache.resp_len",      "labelRotate": "left",      "sortOrder": "default"    },    "yAxisAttrs": [      {        "fields": [          {            "color": "#2A76E4",            "connectNull": false,            "name": "min(apache.resp_len)",            "opacity": 0.6,            "smooth": false,            "type": "line"          }        ],        "range": {}      }    ],    "precision": "",    "showAllXAxisLabels": false,    "labelInterval": "",    "customLabel": "",    "byFields": [      "apache.status"    ],    "legend": {      "placement": "bottom"    }  }}" to json editor
    And I wait for "500" millsecond
    And I click the "Check" button
#    Then I will see the success message "校验通过"
    And I wait for "500" millsecond
...
#    And I compare source image "actual/多Y轴图_修改Yfield" with target image "expect/多Y轴图_修改Yfield"
  ...
  Scenario Outline: range RZY-1337,RZY-3730,RZY-3732
    ...
    When the chart title is "仪表盘多Y轴图" then I click the button which classname is "yotta-icon yotta-icon-DotEmblemOutlined" in dashboard
    And I click the "Edit" button
    Then I set the parameter "{  "title": "仪表盘多Y轴图",  "description": "",  "x": 0,  "y": 0,  "w": 12,  "h": 5,  "search": {    "query": "tag:sample04061424_display | stats count(apache.resp_len), max(apache.resp_len), min(apache.resp_len), sum(apache.status), avg(apache.resp_len) by apache.resp_len,apache.status | limit 10",    "startTime": "now/d",    "endTime": "now"  },  "chart": {    "chartType": "multiaxis",    "xAxis": {      "field": "apache.resp_len",      "labelRotate": "left",      "sortOrder": "default"    },    "yAxisAttrs": [      {        "fields": [          {            "color": "#2A76E4",            "connectNull": false,            "name": "count(apache.resp_len)",            "opacity": 0.6,            "smooth": false,            "type": "line"          }        ],        "range": {          "min": <min>,          "max": <max>        }      }    ],    "precision": "",    "showAllXAxisLabels": false,    "labelInterval": "",    "customLabel": "",    "byFields": [      "apache.status"    ],    "legend": {      "placement": "bottom"    }  }}" to json editor
    And I wait for "500" millsecond
    And I click the "Check" button
#    Then I will see the success message "校验通过"
    And I wait for "500" millsecond
  ...
  Scenario: smooth为true RZY-1339,RZY-3733
    ...
    When the chart title is "仪表盘多Y轴图" then I click the button which classname is "yotta-icon yotta-icon-DotEmblemOutlined" in dashboard
    And I click the "Edit" button
    Then I set the parameter "{  "title": "仪表盘多Y轴图",  "description": "",  "x": 0,  "y": 0,  "w": 12,  "h": 5,  "search": {    "query": "tag:sample04061424_display | stats count(apache.resp_len), max(apache.resp_len), min(apache.resp_len), sum(apache.status), avg(apache.resp_len) by apache.resp_len,apache.status | limit 10",    "startTime": "now/d",    "endTime": "now"  },  "chart": {    "chartType": "multiaxis",    "xAxis": {      "field": "apache.resp_len",      "labelRotate": "left",      "sortOrder": "default"    },    "yAxisAttrs": [      {        "fields": [          {            "color": "#2A76E4",            "connectNull": false,            "name": "count(apache.resp_len)",            "opacity": 0.6,            "smooth": true,            "type": "line"          }        ],        "range": {}      }    ],    "precision": "",    "showAllXAxisLabels": false,    "labelInterval": "",    "customLabel": "",    "byFields": [      "apache.status"    ],    "legend": {      "placement": "bottom"    }  }}" to json editor
    And I wait for "500" millsecond
    And I click the "Check" button
    Then I will see the success message "校验通过"
    And I wait for "500" millsecond
...
#    And I compare source image "actual/多Y轴图_smooth_true" with target image "expect/多Y轴图_smooth_true"
  ...
  Scenario Outline: byFields设为max(apache.resp_len) RZY-1341
    ...
    When the chart title is "仪表盘多Y轴图" then I click the button which classname is "yotta-icon yotta-icon-DotEmblemOutlined" in dashboard
    And I click the "Edit" button
    Then I set the parameter "{  "title": "仪表盘多Y轴图",  "description": "",  "x": 0,  "y": 0,  "w": 12,  "h": 5,  "search": {    "query": "tag:sample04061424_display | stats count(apache.resp_len), max(apache.resp_len), min(apache.resp_len), sum(apache.status), avg(apache.resp_len) by apache.resp_len,apache.status | limit 10",    "startTime": "now/d",    "endTime": "now"  },  "chart": {    "chartType": "multiaxis",    "xAxis": {      "field": "apache.resp_len",      "labelRotate": "left",      "sortOrder": "default"    },    "yAxisAttrs": [      {        "fields": [          {            "color": "#2A76E4",            "connectNull": false,            "name": "count(apache.resp_len)",            "opacity": 0.6,            "smooth": true,            "type": "line"          }        ],        "range": {}      }    ],    "precision": "",    "showAllXAxisLabels": false,    "labelInterval": "",    "customLabel": "",    "byFields": [      "<byFields>"    ],    "legend": {      "placement": "bottom"    }  }}" to json editor
    And I wait for "500" millsecond
    And I click the "Check" button
#    Then I will see the success message "校验通过"
    And I wait for "500" millsecond
  ...
  Scenario Outline: legend RZY-1344
    ...
    When the chart title is "仪表盘多Y轴图" then I click the button which classname is "yotta-icon yotta-icon-DotEmblemOutlined" in dashboard
    And I click the "Edit" button
    Then I set the parameter "{  "title": "仪表盘多Y轴图",  "description": "",  "x": 0,  "y": 0,  "w": 12,  "h": 5,  "search": {    "query": "tag:sample04061424_display | stats count(apache.resp_len), max(apache.resp_len), min(apache.resp_len), sum(apache.status), avg(apache.resp_len) by apache.resp_len,apache.status | limit 10",    "startTime": "now/d",    "endTime": "now"  },  "chart": {    "chartType": "multiaxis",    "xAxis": {      "field": "apache.resp_len",      "labelRotate": "left",      "sortOrder": "default"    },    "yAxisAttrs": [      {        "fields": [          {            "color": "#2A76E4",            "connectNull": false,            "name": "count(apache.resp_len)",            "opacity": 0.6,            "smooth": true,            "type": "line"          }        ],        "range": {}      }    ],    "precision": "",    "showAllXAxisLabels": false,    "labelInterval": "",    "customLabel": "",    "byFields": [      "apache.status"    ],    "legend": {      "placement": "<legend>"    }  }}" to json editor
    And I wait for "500" millsecond
    And I click the "Check" button
#    Then I will see the success message "校验通过"
    And I wait for "500" millsecond
