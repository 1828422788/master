...
#12
  ...
  Scenario Outline: timechart(RZY-3097,3099)
    ...
    Examples:
      ...
      | 3099_column | 0      | 160   | Red        | starttime=\"now/d-24h\" endtime=\"now/d\" tag:sample04061424_chart \| timechart sep=\"-sep分格-\" format=\"$VAL-分格2-$AGG\" cont=true span=30m bins=100 startindex=1 endindex=8 limit=5 rendertype=\"column\" count() min(apache.resp_len) by apache.status |