...
Feature: 字段萃取_eval
  #  详细功能参见testlink中RZY-5417隶属文件夹【eval新字段】中的配置

  Background:
    Given open the "autoProps.ListPage" page for uri "/fieldconfig/"

  Scenario Outline: 添加字段萃取_eval
    ...
    And I click the "AddExtract_eval" button
    And I set the parameter "<EvalName>" with value "<Name>"
    And I set the parameter "EvalField" with value "<EvalField>"
    And I set the parameter "EvalValue" with value "<EvalValue>"
    And I click the "Save" button
    And I wait for "SuccessMessage" will be visible
    And I will see the success message "更新成功"
    Examples:
      |EvalName  | Name | EvalField        |   EvalValue               |
      |EvalName  | autoeval | AutoEval         |   like(appname,"apache")  |
      |EvalName2 | autoeval2| AutoEval2        |   "测试字段萃取eval字段"    |
  ...
  Scenario: 验证eval新字段
    ...
    Then I will see the field "AutoEval:" exist
    Then I will see the field "AutoEval2:" exist

  Scenario: 字段萃取_修改eval字段
    When the data name is "default_search" then i click the "编辑" button
    Then I will see the "autoProps.CreatePage" page
    ...
    And I set the parameter "EvalValue" with value "testExtractEval"
    And I click the "Save" button
    And I wait for "SuccessMessage" will be visible
    And I will see the success message "更新成功"

  Scenario: 验证修改后的字段萃取_eval字段
    Given open the "splSearch.SearchPage" page for uri "/search/"
    And I wait for loading invisible
    And I set the parameter "SearchInput" with value "appname:apache"
    And I click the "DateEditor" button
    ...
    And I click the "RightIcon" button
    Then I will see the field "AutoEval:" exist
    Then I will see the spl search result data "AutoEval2:" doesn't exist

  Scenario: 字段萃取_删除eval字段
    When the data name is "default_search" then i click the "编辑" button
    Then I will see the "autoProps.CreatePage" page
    ...
    And I wait for "AutoEvalDelete" will be visible
    And I click the "AutoEvalDelete" button
    And I wait for "Save" will be visible
    And I click the "Save" button
    And I wait for "SuccessMessage" will be visible
    And I will see the success message "更新成功"

  Scenario: 字段萃取_eval_开启全局共享
    When the data name is "default_search" then i click the "编辑" button
    Then I will see the "autoProps.CreatePage" page
  ...
  Scenario: 验证全局共享_页面验证
    ...
    And I wait for element "AutoEvalGlobal" change text to "来自"
  ...
  Scenario: 验证关闭全局共享
    ...
    And I wait for element "EventsTitle" change text to "事件列表"
    And I click the "RightIcon" button
    Then I will see the spl search result data "AutoEval:" doesn't exist
    ...
    Given open the "app.ListPage" page for uri "/app/1/search/"
    Then I will see the "splSearch.SearchPage" page
    And I set the parameter "SearchInput" with value "appname:apache | stats count() by AutoEval"
    And I click the "DateEditor" button
    And I click the "Today" button
    And I click the "SearchButton" button
    And I wait for element "SearchStatus" change text to "搜索完成!"
