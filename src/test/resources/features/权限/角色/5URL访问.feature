...
Feature: 角色授权URL访问
  ...
  Scenario Outline: 无任何URL访问权限时
    ...
    Examples:
      ...
      | AutoTestRole | qqqqq11111 | {'NonPrivileged':'您暂无设置权限。'} |
...
#    And I click the "SourceEnsure" button
    And I will see the "PublicNavBarPage" page
    And I will see the element value in json "<value>"
    And I click the "Setting" button
    ...
    Examples:
      ...
      | AutoTestRole      | qqqqq11111    | {'Dashboard':'仪表盘','LocateSearchPage':'搜索','AlertsListPage':'监控','TimedTaskPage':'定时任务','Report':'报表','Trend':'趋势图','KnowledgePage':'知识'} | {'Resource1':'搜索','Resource2':'仪表盘','Resource3':'监控','Resource4':'定时任务','Resource5':'报表','Resource7':'知识库','Resource8':'搜索宏','Resource9':'字段提取','Resource10':'事件操作','Resource11':'拓扑图','Resource12':'趋势图','Data1':'日志来源','Data2':'Agent 管理','Data3':'索引配置','Data5':'本地上传','Data6':'备份策略','Authority1':'角色权限','Authority2':'资源分组','Authority3':'用户分组','Authority4':'用户管理'} |
