Feature: 权限-拓扑图
  ...
  Scenario: 重命名拓扑图
    ...
    And I wait for "2000" millsecond
    And open the "topology.ListPage" page for uri "/topology/"
    When the data name is "AutoTest" then i click the "重命名" button
  ...
  Scenario: 修改拓扑图标签
    ...
    And I "checked" the checkbox which name is "可使用拓扑图,新建拓扑图"
    And I click the "SaveButton" button
    And I will see the success message "保存成功"
    Given I will see the "PublicNavBarPage" page
    And I wait for "Dashboard" will be visible
    ...
    And I wait for "2000" millsecond
    And open the "topology.ListPage" page for uri "/topology/"
    When the data name is "AutoRename" then i click the "标签" button
  ...
  Scenario: 根据标签搜索
    ...
    And I choose the "AutoTest" from the "ResourceDropdown"
    And I wait for loading invisible
    Then I will see the search result "AutoRename"