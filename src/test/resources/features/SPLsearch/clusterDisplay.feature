...
Feature: 聚类展示
  ...
  Scenario Outline: RZY-2314:logreduce模式_点击数量
    ...
    Then I will see the div text "<count>" exist in page
...
#    Then I will see the text "233" exist in page
    Then I will see the div text "233" exist in page
