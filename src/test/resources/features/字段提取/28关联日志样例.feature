...
Feature: 字段提取关联日志样例
  ...
  Scenario Outline: RZY-4581选为日志样例
    ...
    Examples:
      ...
      | wym_eventlist_aslogsample | JSON解析 | eventlist.log | {'Address.City':'Portland, New York,Los Angeles','Address.Country':'United States','Address.Street':'324 Chrome St','Age':'23','Employed':'true','Name':'John Smith','raw_message':'{"Name": "John Smith ", "Age": 23, "Employed": true, "Address": {"Street": "324 Chrome St", "City": "Portland, New York,Los Angeles ", "Country": "United States"}}','@appname':'wym_eventlist_aslogsample','@hostname':'666','@tag':'wym_eventlist_aslogsample'} |
