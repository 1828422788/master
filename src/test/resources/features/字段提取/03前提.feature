...
Feature: 字段提取前提条件
  ...
  Scenario Outline: 1542、1543
    ...
    Examples:
      | element   | path | result                                                                                                                                                                                                                                                                                                                                        |
      |           |      | {'Address.City':'Portland, New York,Los Angeles','Address.Country':'United States','Address.Street':'324 Chrome St','Age':'23','Employed':'true','Name':'John Smith','raw_message':'{"Name": "John Smith ", "Age": 23, "Employed": true, "Address": {"Street": "324 Chrome St", "City": "Portland, New York,Los Angeles ", "Country": "United States"}}'} |
  ...
  Scenario Outline: XML解析（RZY-1546）
    ...
    Examples:
      | result                                                                                                                                        |
      | {'test':'3','test[].a':'1,2','raw_message':'<root><test><a>1</a><a>2</a></test><test>3</test></root>'} |