...
#    And I wait for "2000" millsecond
    ...
    And I choose the "timestampstamp" from the "sourceField"
    And I set the parameter "TimeFormat" with value "yyyyMMdd HH:mm:ss"
    And I choose the "Asia/Shanghai" from the "TimeZone"
    And I choose the "en" from the "Language"
    And I click the "EnsureAddParseRule" button
    And I wait for "ParseButton" will be visible
    And I click the "ParseButton" button
    And I wait for "CheckSuccess4" will be visible
...
#    And I wait for "2000" millsecond
    ...
    And I set the parameter "SearchInput" with value "tag:auto_test_format"
...
#    And I set the parameter "StartTimes" with value "<startTime>"
    ...
    Examples:
      ...
      | 2018-08-01 | 2018-09-01 | 00:00:00.000 | 00:00:00.000 |
