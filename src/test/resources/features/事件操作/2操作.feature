...
Feature: 事件操作
  ...
  @second
    Examples:
      ...
      | tag:sample04061424 OR tag:sample04061424_chart | Clientip | RemoveFromSearch | ((tag:sample04061424) OR (tag:sample04061424_chart)) AND NOT 'hostname':192.168.201.2 |