...
#      |	api3_spl统计cnt_邮件_按行发送sample	|
#      |	api0_spl统_cnt_邮件_按行发送sample_连续触发3次	|
#      |	api0_spl统_cnt_邮件_按行发送_抑制_连续触发3次_分组ip交错分布	|
#      |	api0_spl统计_cnt_邮件_按行发送_抑制_连续触发3次_分组字段sample	|
#      |	api0_spl统计_cnt_邮件_按行发送_抑制翻倍_ip分组cnt_10-59min	|
...
#      |	dq_test_api0_spl统计_cnt_邮件_按行发送_抑制_连续触发3次_分组字段sample	|
#      |	交易日_监控_sample	|
