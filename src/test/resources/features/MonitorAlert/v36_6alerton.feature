...
#    And I wait for "3000" millsecond
    ...
    Examples:
      | name                                                     |
      | api00_按行发送_抑制_连续触发3次_分组多字段                               |
      | api00_按行发送_抑制翻倍_cnt_10-59min_分组多字段                       |
      | api3_按行发送_抑制翻倍cnt_10-59min_无分组                           |
      | api3_按行发送_抑制翻倍_cnt_10-59min_分组单字段                        |
      | api00_按行发送_抑制_连续触发3次_分组字段sample                          |
      | api00_字段统计_切分ip_最大数status_扩展chart键值_all_抑制连续触发20次        |
      ...
      | api00_字段统计_切分ip_最大数status_扩展chart键值_all_sample           |
